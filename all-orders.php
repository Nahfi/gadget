    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        ...
        <div class="col col s8 m8 l8">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i>gadget item</a>
            </li>
                <li class="no-padding">
...
<div id="result">
                ...
                <form method="post" class="formValidate" id="formValidate1"  action="all-orders.php">
...
$sql = mysqli_query($con, "SELECT * FROM orders ");
    ...
    $sql = mysqli_query($con, "SELECT * FROM users WHERE uid LIKE $name;");
  ...
  while($row = mysqli_fetch_array($sql))
          ...
          $sql = mysqli_query($con, "SELECT * FROM orders WHERE customer_id LIKE $id");
 
        }
else
{

$sql = mysqli_query($con, "SELECT * FROM orders WHERE id LIKE $name");
          ...
          while($row = mysqli_fetch_array($sql))
          {
            ...
            echo '<li class="collection-item avatar">
                ...
                <form method="post" action="routers/edit-orders.php">
                  ...
                  <input type="hidden" name="ni" value="'.$name.'" placeholder=" " class="" />
  ...
  <option value="ready" '.($status=='ready' ? 'selected' : '').'>ready</option>
            ...
            {
              echo '
              <button class="btn waves-effect waves-light right submit" type="submit" name="">bill
            ...
            while($row1 = mysqli_fetch_array($sql1))
            {
              ...
              echo '<li class="collection-item">
                ...
                echo'<li class="collection-item">
                                        <div class="row">
                                            <div class="col s7">
                                                <p class="collections-title"> Total with fine</p>
                                            </div>
                                            <div class="col s2">
                      <span> </span>
                                            </div>
...
else
{
  ...
  <option value="ready" '.($status=='ready' ? 'selected' : '').'>ready</option>
                ...
                ').'</p>
                              ...
                              if($status=='Delivered')
            {
              echo '<button class="btn waves-effect waves-light right submit" type="submit" name="">bill
                                              <i class="mdi-content-clear right"></i> 
                    </button>
