...
<body>
 ...
 <form method="post" class="formValidate" id="formValidate1"  action="x.php">
...
$p="SELECT * FROM emp2 WHERE id=$id

"; 
//$q="SELECT COUNT(*) ,SUM(amount) FROM `emp2` WHERE id=2";
$sql = mysqli_query($con, "SELECT COUNT(*)as c ,SUM(amount) as s FROM `emp2` WHERE id=$id");
	while($row = mysqli_fetch_array($sql))
          {
...
<li>Total amount : <?php echo "$"; echo $sum; ?> in <?php echo $co ; ?> months</li>
