        ...
        <a href="#" data-activates="slide-out" class="sidebar-collapse btn-floating btn-medium waves-effect waves-light hide-on-large-only cyan"><i class="mdi-navigation-menu"></i></a>
            ...
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">EDIT EMPLOYEE INFO</h4>
              </div>
              <div id="result">
              <div>
    
 <form class="formValidate" id="formValidate" method="post" action="empd.php" novalidate="novalidate">
...
echo '<td><div class="input-field col s12 "><label for="'.$row["id"].'_oprice">contract</label>';

          echo '<input value="'.$row["pn"].'" id="'.$row["id"].'_oprice" name="'.$row['id'].'_oprice" type="text" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></td>'; 




          echo '<td><div class="input-field col s12 "><label for="'.$row["id"].'_price">address</label>';

          echo '<input value="'.$row["address"].'" id="'.$row["id"].'_price" name="'.$row['id'].'_price" type="text" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></td>';


echo '<td><div class="input-field col s12 "><label for="'.$row["id"].'_oq">role</label>';

          echo '<input value="'.$row["cat"].'" id="'.$row["id"].'_oq" name="'.$row['id'].'_oq" type="text" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></td>'; 
          ...
          echo '<select name="'.$row['id'].'_hide">
                      <option value="1"'.$text1.'>Not Available</option>
                      <option value="2"'.$text2.'>Available</option>
                    </select></td></tr>';
        }
        ?>
                    </tbody>
