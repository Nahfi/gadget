      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="users.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Users</a>
             ...
             <li class="bold"><a href="sell.php" class="waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> Sell </a>
              
            </li>		
           
            <li class="bold"><a href="em.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> employee</a>
              
            </li>
            <li class="bold"><a href="emx.php" class="waves-effect waves-cyan"><i class="mdi-editor-attach-money"></i> manage employe</a>
              
            </li>

             <li class="bold"><a href="loss.php" class="waves-effect waves-cyan"><i class="mdi-navigation-arrow-drop-down"></i> Trasaction</a>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">gadget</h5>
              </div>
            </div>
          </div>
        </div>
...
echo '<td><div class="input-field col s12 "><label for="'.$row["id"].'_cat"></label>';

echo '<a href="'.$row["details"].'" class="badge badge-primary p-2"> info</a>    </div></td>'; 
...
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="details_link"> details_link</th>
          ...
          echo '<td><div class="input-field col s12 "><label for="Categories" class="">Categories</label>';
          echo '<input id="cat" name="cat" type="text" data-error=".errorTxt06"><div class="errorTxt06"></div></td>';

          echo '<td><div class="input-field col s12 "><label for="details_link" class="">details_link</label>';
          echo '<input id="details_link" name="details_link" type="text" data-error=".errorTxt06"><div class="errorTxt06"></div></td>';
 
  echo '<td><div class="input-field col s12 "><label for="image" class=""></label>';
          echo '<input id="image" name="image" type="file" data-error=".errorTxt05"><div class="errorTxt05"></div></td>';
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        ...
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="admin-page">us</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
