...
<body class="cyan">
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
      <form class="formValidate" id="formValidate" method="post" action="tic.php" novalidate="novalidate" class="col s12">
        <div class="row">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <label for="name" class="center -align">Adress</label>
          ...
          <div class="input-field col s12">
           ...
           <select name="brand" id="brand">  
                          <option value=""> role</option> 
                                                    <option value="sells_man">sells_man</option>  

                          <option value="normal_employe">normal_employe</option>  
 
                     </select>

            <label for="name" class="center -align">cat</label>
      <div class="errorTxt2"></div>     
          </div>
...
mail: {
      ...
      ID: {
        ...
        messages: {
            ...
            mail: {
                required: "Enter username",
                minlength: "Minimum 5 amd @  characters are required."
            },
            name: {
                required: "Enter name",
                minlength: "Minimum 5 characters are required."
      ...
      ID: {
        required: "Enter ID",
        minlength: "Minimum 11 digit are required."
      },
