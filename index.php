      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
         ...
         <div class="col col s8 m8 l8">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order gadget</a>
            </li>
                <li class="no-padding">
...
<input type="text" name="search_text" id="search_text" placeholder="Search by name" class="form-control" />
 ...
 {  
      $output = '';  
      $sql = "SELECT DISTINCT cat  FROM items";  
...
<select name="brand" id="brand">  
                          <option value="">Search by catgories</option>  
