    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        ...
        <div class="col col s8 m8 l8">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order gadget</a>
            </li>
                <li class="no-padding">
...
//et
   ...
   //am or pm check
            ...
            // et for dinner 
           $t5="17:00:00";//bikel 5 ta

   $d1=DateTime::createFromFormat('H:i:s',$t4);
    //ot
   $d2=DateTime::createFromFormat('H:i:s',$ti);
   //ct
   $d3=DateTime::createFromFormat('H:i:s',$t2);
   //et
     $d4=DateTime::createFromFormat('H:i:s',$t3);
//et for din

          $d5=DateTime::createFromFormat('H:i:s',$t5);

   if($d1->format('H:i:s')<$d2)
   {
    //echo "lol";
    //echo "</br>";
   }
            ...
            if($d3<$d4 || $d3>$d2)
                    ...
                    <button class="btn waves-effect waves-light right submit" type="submit" value="'.$status.'" id="myBtn"name="action">Cancel Order
...
<script type="text/javascript">
  ...
  document.getElementById('myBtn').onclick=function() {
                var x1 = document.getElementById('myBtn').value;

if(x1=='ready')
{confirm('If you want to cancel-order now you have to give fine ');  }
}
</script>
